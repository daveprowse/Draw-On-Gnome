...
**Issue** It appears that I have to change the name of the extension. Reasoning [here](https://github.com/daveprowse/DrawOnYourScreen3/issues/11). I set up a poll for you to vote on what name you would like [here](https://github.com/daveprowse/DrawOnYourScreen3/discussions/12). 
